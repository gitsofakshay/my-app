        ...
        <nav className={`navbar navbar-expand-lg navbar-light bg-light`}>
            <div className="container-fluid">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div className={`form-check form-switch mx-2 text-dark`}>
                        <input className="form-check-input" onClick={props.toggleBlueMode} type="checkbox" role="switch" id="blueMode" />
                        <label className="form-check-label" htmlFor="blueMode">Blue Mode</label>
                    </div>
                    <div className={`form-check form-switch mx-2 text-dark`}>
